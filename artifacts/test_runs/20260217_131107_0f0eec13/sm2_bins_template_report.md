...
- **Selected process differs from recommended process** (PSI1) — Process selection intelligence recommends CNC (score advantage: 5 points) over selected SHEET_METAL. This may indicate suboptimal process choice for material, volume, or geometry.
  - Recommendation: Consider CNC as alternatives. Evaluate tradeoffs: tooling lead time vs unit cost, tolerance/finish requirements, and volume sensitivity.
