...
- **Selected process differs from recommended process** (PSI1) — Process selection intelligence recommends SHEET_METAL (score advantage: 8 points) over selected CNC. This may indicate suboptimal process choice for material, volume, or geometry.
  - Recommendation: Consider SHEET_METAL as alternatives. Evaluate tradeoffs: tooling lead time vs unit cost, tolerance/finish requirements, and volume sensitivity.
